...
export default {
	...
	activated(){
		...
		axios({
			url:`https://m.maizuo.com/gateway?cityId=${cityId}&pageNum=1&pageSize=10&type=1&k=4051705`,
			headers:{
...
<style scoped>
    #content .movie_body{ flex:1; overflow:auto; max-height: 100vh; }
	...
	#content .pullDown{margin:0; padding:0; border:none;}
</style>
